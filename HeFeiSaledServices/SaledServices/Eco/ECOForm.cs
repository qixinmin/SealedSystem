        ...
        private void track_serial_no_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == System.Convert.ToChar(13))
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "select _8sCode from need_to_analysis_8s where track_serial_no='" + this.track_serial_no.Text.Trim() + "' and isLock='true'";
                    ...
                    cmd.CommandText = "select _8sCode from return_modify_more_than_three where track_serial_no='" + this.track_serial_no.Text.Trim() + "' and isLock='true'";
